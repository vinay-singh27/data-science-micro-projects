...
def save_uploaded_image(uploaded_image):
    '''
    This function will take the input file and save it.
    Will raise an error if the file is not able to save
    '''
    try:
...
def extract_features(img_path,model,detector):
    '''
    This function will extract the features from the uploaded
    image
    First, it will use MTCNN to find the face in the uploaded image
    then will use the VGG Model to create the face representation
    '''
...
def recommend(feature_list,features):
    '''
    This function compare the array of the uploaded feature 
    with the avaiable array of face vectors and will the index
    with minimum cosine distance
    '''
